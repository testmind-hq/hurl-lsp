...
Install the **Hurl LSP** extension from the VS Marketplace (search for `hurl-lsp` / `Hurl`).  
Marketplace listing copy lives in [`editors/vscode/README.md`](editors/vscode/README.md).
